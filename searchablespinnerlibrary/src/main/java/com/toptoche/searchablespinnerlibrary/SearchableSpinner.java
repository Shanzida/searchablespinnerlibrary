...
public class SearchableSpinner extends Spinner implements View.OnTouchListener,
    ...
    public static boolean isSpinnerDialogOpen = false; //2022-08-22
    ...
    public boolean onTouch1(View v, MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_UP) {
            if (null != _arrayAdapter) {
                ...
                //Added By Shanzida 2022-07-24
                if (!_searchableListDialog.isAdded()) {
                    _searchableListDialog.show(scanForActivity(_context).getFragmentManager(), "TAG");
                }
                //Added By Shanzida 2022-08-22
                /*if (!_searchableListDialog.isAdded()) {
